...
class image_dataset(object):
    ...
    def load_images(self, filepath='/home/sasha/Desktop/bioFaces/data/celebA_img_norm_mask_light.h5', filepath_shade='/home/sasha/Desktop/bioFaces/data/celebA_shade.h5', shuffle = True):
